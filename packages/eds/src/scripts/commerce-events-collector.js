		...
		return (
			(() => {
				...
				const wi =
					...
					Gi = () => ({ schema: Ei, data: { magentoJsVersion: '1.7.1' } }),
					Yi = (e) => {
						const {
								pageContext: t,
								orderContext: n,
								...
								t.forEach(function (t) {
									Na[t] &&
										(Na[t].sharedState.hasLoaded
											? (_a(e, t), Ba(t))
											: Na[t].sharedState.registeredOnLoadHandlers.push(
													function () {
														_a(e, t), Ba(t);
													},
												));
									...
									if (e)
										try {
											n.subscribe.addToCart(ia),
												...
												n.subscribe.categoryResultsView(Pa),
