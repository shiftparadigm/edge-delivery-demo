...
const handleSubmission = (form) => {
	...
	function handleSuccess() {
		...
		form
			...
			.parent()
			.html(
				'<div class="by-marketo-form-confirmation"><p>Thank you for getting in touch! We appreciate you contacting us and we will respond within two business days with more information.</p></div>',
			);
		return false;
	}
...
const handleScriptLoaded = (formTarget) => {
	...
	const observer = new MutationObserver((mutationList) => {
		const labels = mutationList[0].target.querySelectorAll(
